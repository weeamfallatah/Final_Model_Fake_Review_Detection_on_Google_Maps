                ...
                if (text != "") {
                    ...
                    if (obj.length > 0) {
                        for (var x = 0; x < obj.length; x++) {
                            ...
                            data += "<p class='w3-col w3-s12 m6 l6 w3-right '>الاسم " + obj[x].fullName + "</p>";
                            ...
                            data += "<p class='w3-col w3-s12 m6 l6 w3-right'>المراجعات المزيفة  : " + obj[x].fakeReview + "</p>";
                            data += "<p class='w3-col w3-s12 m6 l6 w3-right'>المراجعات الموثوقة  : " + obj[x].SampleReview + "</p>";
                            data += "</div>";
                        }
                    }
                }
