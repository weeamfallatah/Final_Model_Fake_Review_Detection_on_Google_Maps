...
function search() {
    try {
        ...
        $.ajax({
            type: "GET",
            url: "https://api.app.outscraper.com/maps/reviews-v2?async=false&apiKey=Z29vZ2xlLW9hdXRoMnwxMDEyOTQ2MjUxMzg0MTA2NTg5Mzh8OTJlNjY5NGUzYg&reviewsLimit="
                + sampleNo + "&query=" + location + "&language=" + language,
            ...
            success: function (text) {
               ...
               // document.getElementById("reallyRate").innerHTML = "التقيم للعينة  : " + text.data[0].reviews;
                ...
                for (var i = 0; i < text.data[0].reviews_data.length; i++) {
                    ...
                    info += "<p class='w3-container' style='text-align:right ; font - family: courier; font - size: 90 %; color:#696969'>" + text.data[0].reviews_data[i].review_text + "</p>";
                    //-------------------------
                    ...
                    if (ratio >= Database_ratio) {
                        ...
                        fake += "<p class='w3-container' style='text-align:right ; font - family: verdana; font - size: 90 %; color:#696969'>" + text.data[0].reviews_data[i].review_text + "</p>";
                    }
                    else {
                        ...
                        good += "<p class='w3-container' style='text-align:right ; font - family: verdana; font - size: 90 %; color:#696969'>" + text.data[0].reviews_data[i].review_text + "</p>";
                    }
                ...
                $.ajax({
                    ...
                    data: { searchAddress: location, currentRate: text.data[0].rating, sampleRate: SampleRate, actualRate: actualRate, totalReview: text.data[0].reviews, SampleReview: text.data[0].reviews_data.length, fakeReview: fakeReview },
                    success: function (text) {
                        if (text == "1") showMessage("تم الحفظ بنجاح");
